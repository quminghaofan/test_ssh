	...
	<div class="ExcAllCon">
		<div class="ExcCon">
			<div class="ExcCon01">
				...
				主编：<input type="text" name="RRname" style="border:none" value="${news.chiefEditor.name}" readonly="readonly"/>
				</pre>
				<pre class="f14 cGray" align="center">
				采编：<input type="text" name="RRname" style="border:none" value="${news.editor.name}" readonly="readonly"/>
				</pre> 
			</div>
			<div>
				<video width="590" height="340" id="media"  poster="/images/poster.jpg" onclick="showVideo(this.value)" controls>
