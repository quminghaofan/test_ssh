...
.allHeader .navFind .headSel {
	...
	border-right: none;
	background: #fff
		url(http://img.ifeng.com/tres/TemplateRes/14415/14415/images/general_head/nav0416_04.gif)
...
.allHeader .navFind .headButton {
	...
	border: none;
	background:
		url(http://img.ifeng.com/tres/TemplateRes/14415/14415/images/general_head/navFind.gif)
		no-repeat 0 0;
	color: #000;
	font-weight: bold;
	cursor: pointer;
	...
	<div class="ExcTit">
		<div class="ExcTitCon clearfix">
			<div class="ExcShare fr">
				...
				<div>
					<script
						src="http://y0.ifengimg.com/commonpage/1130/F-RequireJS.min.js"></script>
					<script>
...
.new_share {
	margin: 0 7px;
					...
					<div>
						<a class="Excbds_tsina js_swShare new_share" data-type="sina"
							href="#"></a> <a class="Excbds_qzone js_qzShare new_share"
							data-type="qqZone" href="#"></a> <a
							class="Excbds_twx js_qrcode new_share" data-type="weixin"
							href="#"></a>
					</div>
				</div>
				<script>
					var data_info = eval('('
							+ jq(".js_shareList").closest("[data-info]").attr(
									"data-info") + ')');
		...
		<div class="ExcAllCon">
			<div class="ExcCon">
				...
				主编：<input type="text" name="RRname" style="border: none"
							value="${news.chiefEditor.name}" readonly="readonly" />
				</pre>
					<pre class="f14 cGray" align="center">
				采编：<input type="text" name="RRname" style="border: none"
							value="${news.editor.name}" readonly="readonly" />
				</pre>
				</div>
				<div>
					<video width="590" height="340" controls> <source
						src="__VIDEO__.MP4" type="video/mp4" /> <source
						src="__VIDEO__.OGV" type="video/ogg" /> <object width="640"
				...
				<div class="ExcConPicBox">
					<img src="${news.picUrl}" height="340" width="590"
						readonly="readonly" />
				</div>
				<div class="ExcCon04 ExcWay" id="ExcWay01" name="ExcWay01">
					<p id="textarea" style="text-indent: 2em">${news.content}</p>
				</div>
			</div>
			<div id="fright">
