...
#d{width:200px; height:30px;float:left}
#s{width:135px;height:30px;float:left}
#btn{width:60px;height:30px;float:right;}	
</style>
</head>
...
<body>
	...
	<div id="d">
		...
		<fieldset class="search">
				<input type="text" class="box" name="s" id="s" class="inputText" placeholder="输入您要搜索的艺术品" x-webkit-speech>
				<button class="btn" title="SEARCH" id="btn">搜索</button>
		</fieldset>
		</form>
	</div>


	 <!--<h4 class="head_single">我的艺术品</h4>-->
	 <p><font color="red">如果您要定制相关艺术品，请点击进入艺术品</font></p>
