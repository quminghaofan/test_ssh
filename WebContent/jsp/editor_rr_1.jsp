...
<table class="table table-bordered table-hover definewidth m10">
    ...
    <c:forEach items="${RRLIST}" var="rr">
        <tr>
                ...
                <td><a href="/test_ssh/news/showNews?type=4">查看</a>&nbsp;&nbsp;<a href="/test_ssh/editor/withdraw?type=0&newsId=${rr.id}">撤回</a>&nbsp;&nbsp;<a href="javascript:void(0)" onclick="if(window.confirm('确定删除该项吗？')) this.href='/test_ssh/editor/delNews?newsId=${rr.id}'">删除</a></td>
            </tr>
    </c:forEach>
</c:if>
        </table>
