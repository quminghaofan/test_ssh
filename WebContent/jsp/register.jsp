				 ...
				 <div class="register-top-grid">
					<h3>欢迎来到注册界面</h3>
					 <div>
						...
						<input type="tel" id="p" name="phone" onblur="return checkPhoneNumber()"/> 						
					 </div>
					 <div>
						<span>密码<label>*</label></span>
						<input name="password" type="password" id="password" onblur="return checkPassword()"/> 
					 </div>
					 <div>
						 <span>确认密码<label>*</label></span>
						 <input name="password2" type="password" id="password2" onblur="return checkPassword2()"/> 
					 </div>
					 <div>
						 <span>验证码<label>*</label></span>
						 <input type="check" onblur="return verify()"> 						
						<input type="button" name="send" value="发送验证码" style="float:right"  onclick=sendSMS() />
					 </div>
					 <div class="clearfix"> </div>
					   <a class="news-letter" href="#">
						 <label class="checkbox"><input type="checkbox" name="checkbox" checked="checked"><i> </i>同意该网站协定</label>
					   </a>
					 </div>
				<div class="clearfix"> </div>
